...
This command: durable implementation authorization (G3.5) is a precondition — without it, do not transition the selected row or start target edits; after start, unresolved deviations keep the row incomplete.
