...
4. [Input] Run the judge against the declared legacy/contract and target observations; validate the judge with a controlled mismatch where practical.
