...
| `evidence-grading` | explicit claim; referenced evidence; existing evidence record when present | feature: `FEATURE_ROOT/evidence/<evidence-id>.md`; project: `migration/evidence/<evidence-id>.md` | Follow `docs/09-evidence-grade-transition-control.md`; if evidence does not justify greater certainty, do not upgrade the grade. |
...
8. follow `docs/09-evidence-grade-transition-control.md` for grade transitions and preserve the stricter requirements of #11 for verification.
