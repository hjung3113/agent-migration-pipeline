...
9. Issue #9 (evidence-grade history), issue #10 (observed/inferred provenance), and issue #11 (verification-judge self-check) are stricter semantic controls. Issue #6 must preserve them rather than flattening them into generic branching prose.
